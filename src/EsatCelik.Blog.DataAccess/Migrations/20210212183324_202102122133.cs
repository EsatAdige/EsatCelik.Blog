...
{
    public partial class _202102122133 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "CategoryName", "InsertDate", "InsertedBy" },
                values: new object[] { 1, "Game", new DateTime(2021, 2, 12, 21, 33, 24, 346, DateTimeKind.Local).AddTicks(3914), 0 });

            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "CategoryName", "InsertDate", "InsertedBy" },
                values: new object[] { 2, "Travel", new DateTime(2021, 2, 12, 21, 33, 24, 346, DateTimeKind.Local).AddTicks(4397), 0 });

            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "CategoryName", "InsertDate", "InsertedBy" },
                values: new object[] { 3, "Photography", new DateTime(2021, 2, 12, 21, 33, 24, 346, DateTimeKind.Local).AddTicks(4400), 0 });
